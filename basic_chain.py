...
def basic_chain(model=None, prompt=None):
    ...
    if not prompt:
        ...
        "Por favor, proporciona más detalles o reformula tu consulta. Pregunta actual: {input}"
        )
...
def main():
    ...
    prompt = ChatPromptTemplate.from_template("Dime los libros más destacados del autor {author}")
